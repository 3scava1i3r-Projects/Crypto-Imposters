...
for x in range(0, 1):
    ...
    dk = (randint(0, 256), randint(0, 256), randint(0, 256)) #goggle color
    ...
    Angel_Imposter = [
        ...
        [bg, bg, bg, bg, bg, ol, jc, ol, bg, bg, bg, ol, bg, bg, bg, bg, bg, bg, bg, ol, bg, bg, bg, bg],
        [bg, bg, bg, bg, ol, jc, jc, ol, bg, bg, bg, ol, bg, bg, bg, bg, bg, bg, bg, ol, bg, bg, bg, bg],
        [bg, bg, bg, bg, ol, jc, jc, ol, bg, bg, bg, ol, bg, bg, bg, bg, bg, bg, bg, ol, bg, bg, bg, bg],
        [bg, bg, bg, bg, ol, jc, jc, ol, bg, bg, bg, ol, bg, bg, bg, bg, bg, bg, bg, ol, bg, bg, bg, bg],
